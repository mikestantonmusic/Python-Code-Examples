...
def render_content(tab):
    if tab == 'tab-1':
        return html.Div([
            ...
            html.Br(),
            dbc.Row([drawGraph(group_table('Duration', 'Duration'),'Duration','Rate','line','Duration','Duration','Averate Rating')]), 
            html.Br(),
            dbc.Row([drawGraph(group_table('Certificate'),'Certificate','Rate','bar','Certificate','Certificate','Averate Rating')]), 
            html.Br(),
            dbc.Row([
                drawGraph(group_table('Nudity'),'Nudity','Rate','bar','Nudity','Nudity','Averate Rating',6), 
                drawGraph(group_table('Violence'),'Violence','Rate','bar','Violence','Violence','Averate Rating',6),
                #align='center'
                ]),
            html.Br(), 
            dbc.Row([
                drawGraph(group_table('Profanity'),'Profanity','Rate','bar','Profanity','Profanity','Averate Rating',6), 
                drawGraph(group_table('Alcohol'),'Alcohol','Rate','bar','Alcohol','Alcohol','Averate Rating',6),
                #align='center'
                ]),
            html.Br(),                        
            dbc.Row([drawGraph(group_table('Frightening'),'Frightening','Rate','bar','Frightening','Frightening','Averate Rating')]), 
            html.Br(),
            dbc.Row([drawGraph(group_table('Date', 'Date'),'Date','Rate','line','Date','Date','Averate Rating')]), 
            html.Br(),
            dbc.Row([drawGraph(genre_table(),'Genre','Rate','bar','Genre','Genre','Averate Rating')]), 
            html.Br(),
            dbc.Row([drawGraph(votes_table(),'Votes','Rate','scatter','Votes','Votes','Averate Rating')]), 
            html.Br()   
        ]),
...
# tab 2
        ...
        return html.Div([
            dbc.Row([drawText('Average Votes Analysis')], align='center'),
            html.Br(),
            dbc.Row([drawGraph(group_table('Duration', 'Duration'),'Duration','Votes','line','Duration','Duration','Average Votes')]), 
            html.Br(),
            dbc.Row([drawGraph(group_table('Certificate'),'Certificate','Votes','bar','Certificate','Certificate','Average Votes')]), 
            html.Br(),
            dbc.Row([
                drawGraph(group_table('Nudity'),'Nudity','Votes','bar','Nudity','Nudity','Average Votes',6), 
                drawGraph(group_table('Violence'),'Violence','Votes','bar','Violence','Violence','Average Votes',6),
                #align='center'
                ]),
            html.Br(), 
            dbc.Row([
                drawGraph(group_table('Profanity'),'Profanity','Votes','bar','Profanity','Profanity','Average Votes',6), 
                drawGraph(group_table('Alcohol'),'Alcohol','Alcohol','bar','Alcohol','Alcohol','Average Votes',6),
                #align='center'
                ]),
            html.Br(),                        
            dbc.Row([drawGraph(group_table('Frightening'),'Frightening','Votes','bar','Frightening','Frightening','Average Votes')]), 
            html.Br(),
            dbc.Row([drawGraph(group_table('Date', 'Date'),'Date','Votes','line','Date','Date','Average Votes')]), 
            html.Br(),
            dbc.Row([drawGraph(genre_table(),'Genre','Votes','bar','Genre','Genre','Average Votes')]), 
            html.Br(),
            dbc.Row([drawGraph(votes_table(),'Rate','Votes','scatter','Rate','Rate','Average Votes')]), 
            html.Br()   
        ]),
